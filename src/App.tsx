    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-800">Ghibli Portrait</h1>
                <p className="text-sm text-gray-600">AI-Powered Art Generator</p>
              </div>
            </div>
            {state !== 'welcome' && (
              <button
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {state === 'welcome' && (
          <div className="text-center space-y-8">
            <div className="space-y-4">
              <div className="w-24 h-24 bg-gradient-to-br from-emerald-400 to-teal-600 rounded-full flex items-center justify-center mx-auto">
                <Camera className="w-12 h-12 text-white" />
              </div>
              <h2 className="text-3xl font-bold text-gray-800">Transform Your Portrait</h2>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 max-w-md mx-auto">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-gray-700">Take a clear portrait photo</span>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-8 h-8 bg-teal-100 rounded-full flex items-center justify-center">
                    <Sparkles className="w-4 h-4 text-teal-600" />
                  </div>
                  <span className="text-gray-700">AI processes your image</span>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-8 h-8 bg-cyan-100 rounded-full flex items-center justify-center">
                    <Download className="w-4 h-4 text-cyan-600" />
                  </div>
                  <span className="text-gray-700">Download your Ghibli portrait</span>
                </div>
              </div>
            </div>
        ...
        {state === 'camera' && (
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Position Yourself</h2>
              <p className="text-gray-600">Center your face in the frame for the best results</p>
              {!isCameraReady && (
                <p className="text-sm text-emerald-600 mt-2 flex items-center justify-center space-x-2">
            ...
            <div className="relative max-w-lg mx-auto">
              ...
              {isCameraReady && (
                <>
                  <div className="absolute inset-0 border-4 border-emerald-400 rounded-2xl pointer-events-none opacity-50"></div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-64 border-2 border-white rounded-full pointer-events-none opacity-60"></div>
                </>
              )}
            </div>
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button
                onClick={reset}
                className="bg-white text-gray-700 px-6 py-4 rounded-full font-semibold text-lg hover:bg-gray-50 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Cancel
              </button>
            </div>
        ...
        {state === 'preview' && capturedImage && (
          <div className="space-y-6">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">How does this look?</h2>
              <p className="text-gray-600">Review your photo before generating the Ghibli-style artwork</p>
            </div>
            ...
            <div className="max-w-lg mx-auto">
              <div className="relative">
                ...
                />
                <div className="absolute inset-0 border-4 border-emerald-400 rounded-2xl pointer-events-none opacity-30"></div>
              </div>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-6 max-w-md mx-auto">
              <div className="text-center space-y-2">
                ...
                <p className="text-gray-700 font-medium">Ready to create magic?</p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button
                ...
                className={`px-8 py-4 rounded-full font-semibold text-lg transition-all duration-200 transform shadow-lg flex items-center justify-center space-x-2 ${
                  isProcessing
                    ? 'bg-gray-400 text-white cursor-not-allowed'
                    : 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white hover:from-emerald-600 hover:to-teal-700 hover:scale-105 hover:shadow-xl'
                }`}
              >
                ...
                <span>{isProcessing ? 'Generating...' : '🎨 Generate Ghibli Image'}</span>
              </button>
              
              <button
                onClick={retakePhoto}
                disabled={isProcessing}
                className={`bg-white text-gray-700 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-200 transform shadow-lg hover:shadow-xl flex items-center justify-center space-x-2 ${
                  isProcessing 
        ...
        {state === 'processing' && (
          <div className="text-center space-y-8">
            <div className="space-y-4">
              <div className="w-24 h-24 bg-gradient-to-br from-emerald-400 to-teal-600 rounded-full flex items-center justify-center mx-auto animate-pulse">
                <Sparkles className="w-12 h-12 text-white" />
              </div>
              <h2 className="text-3xl font-bold text-gray-800">Creating Your Ghibli Portrait</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 max-w-md mx-auto">
              <div className="space-y-4">
                <div className="flex items-center justify-center space-x-4">
                  ...
                  <span className="text-gray-700 font-medium">Processing your image...</span>
                </div>
            ...
            {capturedImage && (
              <div className="max-w-sm mx-auto">
                <img
                  ...
                  className="w-full h-auto rounded-2xl shadow-xl opacity-75"
                />
              </div>
            )}
          </div>
        ...
        {state === 'result' && result && (
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-gray-800 mb-2">Your Ghibli Portrait</h2>
            ...
            <div className="flex justify-center space-x-4">
              <button
                ...
                className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:from-emerald-600 hover:to-teal-700 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2"
              >
              ...
              <button
                onClick={reset}
                className="bg-white text-gray-700 px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-50 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2"
              >
        ...
        {/* Error Message */}
        {error && (
          <div className="fixed bottom-4 left-4 right-4 bg-red-500 text-white px-6 py-4 rounded-lg shadow-lg z-50 max-w-md mx-auto">
            <div className="flex items-center justify-between">
